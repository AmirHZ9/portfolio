      ...
      <div className="skills flex flex-col justify-center items-center lg:flex-row" >
        <div className="flex flex-col  items-start justify-center w-full h-full px-[50px] mb-8  mx-8" data-aos="fade-right">
          ...
          <div className="text-center text-text" >
            ...
            <p>
            Front-end developer with strong in HTML, CSS, and JavaScript. Proficient in React. Fast learner, detail-oriented, and committed to writing clean code. Seeking employment opportunities to contribute to innovative projects.
            </p>
          </div>
        </div>
